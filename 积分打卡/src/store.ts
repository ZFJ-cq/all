...
import type { Task, CheckinRecord, ExchangeRecord, AppConfig, StreakInfo, BackupData } from './types';
    ...
    (set, get) => ({
      ...
      exchange: (tier) => {
        ...
        set((state) => ({
          ...
          config: { ...state.config, totalPointsSpent: state.config.totalPointsSpent + tier },
        }));
      },
